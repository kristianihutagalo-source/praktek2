...
export default function HomeScreen() {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.name}>Rachel Krisyanti Hutagalung</Text>
      <Text style={styles.nim}>NIM: 243303621258</Text>
      ...
      <View style={styles.bioCard}>
        <Text style={styles.bioText}>
          - “Mastering React Native SDK 50 🧠 — destined to drop goated apps!”
        ...
        <Text style={styles.quoteText}>
          "Code bukan sekadar baris, tapi karya yang mengubah dunia."
        </Text>
      </View>
    </SafeAreaView>
  );
